          ...
          <section className="p-6 sm:p-10 lg:p-12">
            <div className="mb-9 max-w-2xl space-y-3">
              ...
              <p className="text-base leading-7 text-muted-foreground">
                Welcome, {user.name}. Choose a starting template for how Relay
                finds important context in your mail. You can change this
                preference later.
              </p>
            </div>
          ...
          <aside className="border-t bg-muted/30 p-6 sm:p-8 lg:border-l lg:border-t-0">
            ...
            <ol className="mt-6 space-y-5">
              {[
                ...
                ["2", "Connect your tools", "Gmail and Google Calendar"],
                ["3", "Add an AI provider", "Bring your own API key"],
                ["4", "Set limits and sync", "Usage cap and recent mail"],
            ...
            <div className="mt-8 rounded-xl border bg-background p-4">
              ...
              <p className="mt-1 text-xs leading-5 text-muted-foreground">
                Relay never sends an email or books an event without your
