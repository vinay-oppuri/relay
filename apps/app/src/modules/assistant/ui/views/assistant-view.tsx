  ...
  return (
    <SidebarProvider className="min-h-screen bg-background">
      ...
      <SidebarInset className="min-w-0">
        <header className="flex h-16 items-center justify-between border-b px-5 sm:px-7">
        ...
        <div className="flex flex-1 flex-col px-5 py-8 sm:px-8">
          <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col justify-center">
            ...
            <p className="mt-3 max-w-xl leading-7 text-muted-foreground">
              Relay answers from your synced mail, cites its sources, and waits
              for your confirmation before sending or booking anything.
            </p>
      ...
      <aside className="hidden border-l bg-muted/10 xl:block">
        <div className="flex h-16 items-center justify-between border-b px-5">
          <p className="font-semibold">Recent mail</p>
        ...
        <div className="divide-y">
          {recentMail.length ? (
            recentMail.map((mail) => (
              <article className="space-y-2 p-5" key={mail.id}>
            ...
            <p className="p-5 text-sm leading-6 text-muted-foreground">
              No mail has been synced yet. Connect Gmail during setup to fill
              this inbox.
            </p>
          )}
        </div>
